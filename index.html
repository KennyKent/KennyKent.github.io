...
<header id="header" class="alt">
    <a href="#banner">Accueil</a></li>
    <a href="#aboutme">A propos de moi</a></li>
    <a href="#skills">Compétences</a>
    <a href="#formations">Formations</a>
    <a href="#exper">Expériences</a>
</header>
...
<section id="banner">
    <div class="inner">
        <header>
            <h1>Kenzy Suon</h1>
            <p>Etudiant en 3ème année de Bachelor à l'ECE TECH<br/>
                Spécialité Développement Mobile, Web
                et Logiciel
            </p>
            <ul class="icons">
                <li><a href="https://github.com/KennyKent/" title="Github" class="icon fa-github"><span
                                class="label"></span></a></li>
                <li><a href="https://www.linkedin.com/in/kenzy-suon-141076107/" title="Mon profil Linkedin"
                       class="icon fa-linkedin"><span class="label"></span></a></li>
                <li><a href="/cvWeb/images/CV.pdf" class="icon fa-download" download="CV"
                       title="Download CV"></span></a>
                </li>
            </ul>
        </header>
    </div>
...
<main>
    <!-- Section About Me -->
    <section class="wrapper style1" id="aboutme">
        <div class="inner">
    ...
    <!-- Section Skills -->
    <section class="wrapper style2" id="skills">
    ...
    <!-- Section Expériences -->
    <section class="wrapper style1" id="exper">
        <div class="inner container-fluid">
